...
const AR_STRINGS = {
  ...
  "Custom Sections": "أقسام مخصصة", "Pages": "الصفحات", "Site Settings": "إعدادات الموقع", "SEO": "مشاركة الرابط (SEO)",
  ...
  "SEO Settings": "إعدادات السيو ومشاركة الرابط",
  "SEO & Share Preview": "السيو ومظهر الرابط عند المشاركة",
...
const SCHEMAS = {
  ...
  seo_settings: {
    table: "seo_settings", title: "SEO & Share Preview", singular: "Page SEO",
    subtitle: "Controls how the link appears when shared (WhatsApp, Facebook, Telegram, LinkedIn…). Use page_key = home for the main page. OG fields = big title + description + cover image.",
    orderBy: "id",
    listCols: [
    ...
    fields: [
      { key: "page_key", type: "text", label: "Page key (unique) — use home for main page", placeholder: "home" },
      { key: "title", type: "i18n", label: "SEO Title (browser tab)" },
      { key: "description", type: "i18n_textarea", label: "SEO Description (search engines)" },
      { key: "keywords", type: "i18n", label: "Keywords" },
      { key: "og_title", type: "i18n", label: "Share Title (big title when sharing the link)" },
      { key: "og_description", type: "i18n_textarea", label: "Share Description (text under the title)" },
      { key: "og_image_url", type: "image", label: "Share Cover Image (recommended 1200×630)", folder: "seo" },
      { key: "canonical_url", type: "text", label: "Canonical URL (full page URL)" },
      { key: "robots_index", type: "boolean", label: "Allow indexing by Google", default: true },
